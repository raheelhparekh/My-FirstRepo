    ...
    public static void main(String[] args)
     {
        ...
        System.out.println("Enter the  number of accounts you already have:");
        int n = sc.nextInt();
        int n1 = n;
        if(n<=c) 
        {
            for(int i=0;i<n;i++) //taking inputs from user about account he already has
            {
            ...
            do{
                ...
                System.out.println("Press 4.Exit");
                 ...
                 switch(choice)
                 {
                    case 1: if (n>= c) // if no of acc are greater than no of users account it already has then direct print data full
                    {
